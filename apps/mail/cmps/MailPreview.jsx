...
export function MailPreview({ mail, onClick, onToggleStarred, onToggleReadStatus, onRemoveMail, onReplyClick, onSaveMailAsNote, onUpdateMailLabels }) {
    ...
    return (
        ...
        >
            ...
            <div className="star-cell" title={starred ? 'Starred' : 'Not starred'}>
                <p className={`star ${starred ? 'starred' : ''}`}
                    onClick={(ev) => onToggleStar(ev)}>
                    {starred ? '★' : '☆'}
                </p>
            </div>
            <div className="from-cell">{senderOrRecipient}</div>
            ...
            {isHovered && (
                <div className="action-buttons">
                    ...
                    />
                    <button title='Reply' onClick={(ev) => onReplyClick(mail.id, ev)}><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f"><path d="M760-200v-160q0-50-35-85t-85-35H273l144 144-57 56-240-240 240-240 57 56-144 144h367q83 0 141.5 58.5T840-360v160h-80Z" /></svg></button>
                    <button title={isRead ? 'Mark as unread' : 'Mark as read'} onClick={(ev) => onToggleReadStatus(mail.id, ev)}>
                    ...
                    <button title='Save as note' onClick={(ev) => onSaveMailAsNote(mail.id, ev)}><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h560q33 0 56.5 23.5T840-760v268q-19-9-39-15.5t-41-9.5v-243H200v560h242q3 22 9.5 42t15.5 38H200Zm0-120v40-560 243-3 280Zm80-40h163q3-21 9.5-41t14.5-39H280v80Zm0-160h244q32-30 71.5-50t84.5-27v-3H280v80Zm0-160h400v-80H280v80ZM720-40q-83 0-141.5-58.5T520-240q0-83 58.5-141.5T720-440q83 0 141.5 58.5T920-240q0 83-58.5 141.5T720-40Zm-20-80h40v-100h100v-40H740v-100h-40v100H600v40h100v100Z" /></svg></button>
                    <button title='Delete' onClick={(ev) => onRemoveMail(mail.id, ev)}><svg xmlns="http://www.w3.org/2000/svg" height="20px" viewBox="0 -960 960 960" width="20px" fill="#1f1f1f"><path d="M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z" /></svg></button>
                </div>
            )}
        </section>
    )
